...
- GeoLite2-City.mmdb  (2025-12-12)
- GeoLite2-Country.mmdb  (2025-12-12)
- GeoLite2-ASN.mmdb  (2025-12-12)
...
| `-e LOG_TYPE_FILE_PATTERN=`         |   (Optional) Only to be used with LOG_TYPE=NCSA_COMBINED or CADDY_V1. This parameter will pass along the file type you are trying match. For example you can pass -e LOG_TYPE_FILE_PATTERN="*.log" or -e LOG_TYPE_FILE_PATTERN="access.log". The default is *.log. Please keep it simple as I have not tested this completely. Use at your own RISK! |
